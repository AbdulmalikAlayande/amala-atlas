...
class SpotSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        models = models.Spot
        fields = ('id', 'public_id', 'created_at', 'last_modified_at', 'name', 'address', 'city', 'state', 'lat', 'lng', 'photo_urls')
...
class CandidateSubmissionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            "tags", "hours_text", "email", "photo_urls", "phone", "website", "transcript", "raw_payload"
        )
